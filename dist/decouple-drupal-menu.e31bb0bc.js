...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"node_modules/whatwg-fetch/fetch.js":[function(require,module,exports) {
"use strict";
...
},{"whatwg-fetch":"node_modules/whatwg-fetch/fetch.js"}],"js/menu.class.js":[function(require,module,exports) {
'use strict';
...
function () {
  ...
  _createClass(Menu, [{
      ...
      list.data.forEach(function (item) {
        ...
        switch (true) {
          ...
          case splitItem.length == 6:
            tempItem = {
              parent: splitItem[splitItem.length - 2],
              data: item
            };
            ...
            switch (lvl) {
              case 'lvl1':
                spliceMenu[lvl].forEach(function (item) {
                  ...
                  if (controller.language == item.data.langcode) {
                    ...
                    cleanMenuSection[tempIndexLast] = {
                      link: item.data.url_alias.split('?')[0],
                      name: item.data.name,
                      id: item.data.tid,
                      children: {}
                    };
                ...
                spliceMenu[lvl].forEach(function (item) {
                  ...
                  if (item.data.field_organization_head_name) {
                    if (controller.language == item.data.langcode) {
                      ...
                      // console.log(tempIndexLast);
                      cleanMenuSection[tempIndex1].children[tempIndexLast] = {
                        link: item.data.url_alias.split('?')[0],
                        name: item.data.name,
                        id: item.data.tid,
                        person: item.data.field_organization_head_name,
                        children: {}
                      };
                    }
                  } else {
              ...
              case 'lvl3':
                spliceMenu[lvl].forEach(function (item) {
                  ...
                  var tempIndexLast = tempIndex[tempIndex.length - 1].split('?')[0]; // console.log(item);
                  // console.log(tempIndex1);
                  // console.log(tempIndex2);
                  // console.log(tempIndexLast);

                  if (controller.language == item.data.langcode) {
                    cleanMenuSection[tempIndex1].children[tempIndex2].children[tempIndexLast] = {
                      link: item.data.url_alias.split('?')[0],
                      name: item.data.name,
                      id: item.data.tid,
                      children: {}
              ...
              case 'lvl4':
                spliceMenu[lvl].forEach(function (item) {
                  ...
                  if (controller.language == item.data.langcode) {
                    cleanMenuSection[tempIndex1].children[tempIndex2].children[tempIndex3].children[tempIndexLast] = {
                      link: item.data.url_alias.split('?')[0],
                      name: item.data.name,
                      id: item.data.tid,
                      children: {}
    ...
    key: "checkAlias",
    value: function checkAlias(item, lang) {
      // console.log(item);
      var tempLang = lang == 'en' ? '' : "/".concat(lang);
      var tempResult = '';

      switch (item.id) {
        case '1501':
          tempResult = "<a href=\"".concat(tempLang, "/taxonomy/term/").concat(item.id, "\"><span>").concat(item.name, " - ").concat(item.person, "</span></a>");
          break;
        ...
        default:
          tempResult = "<a href=\"".concat(tempLang, "/taxonomy/term/").concat(item.id, "\"><span>").concat(item.name, "</span></a>");
          break;
      }
    ...
    value: function buildMenu(data, controller) {
      // console.log(data);
      controller.menu.markup = "<div class=\"search-box\">\n      <span></span>\n      <input id=\"menu-search\" type=\"text\" name=\"\" value=\"\" ".concat(controller.language == 'Arabic' ? "placeholder=\"\u0628\u062D\u062B\"" : "").concat(controller.language == 'Bengali' ? "placeholder=\"\u0985\u09A8\u09C1\u09B8\u09A8\u09CD\u09A7\u09BE\u09A8\"" : "").concat(controller.language == 'Spanish' ? "placeholder=\"BUSCAR\"" : "").concat(controller.language == 'English' ? "placeholder=\"SEARCH\"" : "", ">\n    </div>");
      ...
      if (data.length) {
        ...
        data.forEach(function (taxSet) {
          // console.log(taxSet);
          controller.menu.markup += "<div class=\"nav-item lvl-1\">\n        ".concat(taxSet.name == 'DEPARTMENTS' ? "<a href=\"/".concat(taxSet.name.toLowerCase(), "\"><span>").concat(transWords[0], "</span></a>") : '', "\n        ").concat(taxSet.name == 'GOVERNMENT' ? "<a href=\"/".concat(taxSet.name.toLowerCase(), "\"><span>").concat(transWords[1], "</span></a>") : '', "\n        ").concat(taxSet.name == 'CENSUS' ? "<a href=\"/census\"><span>".concat(transWords[13], "</span></a>") : '', "\n        ").concat(taxSet.name == 'HOW DO I' ? "<a href=\"/how-do-i\"><span>".concat(transWords[2], "</span></a>") : '', "\n        <div class=\"sub-items-btn\"></div>\n        <article class=\"nav-container lvl-2\">\n          <div class=\"nav-item back lvl-2\">\n            <i class=\"fas fa-angle-left\"></i> ").concat(transWords[3], "\n          </div>");
          ...
          var tempLang = controller.languageCode === 'en' ? '' : "/".concat(controller.languageCode);

          for (var link in multiMenu) {
            if (multiMenu.hasOwnProperty(link)) {
              controller.menu.markup += "<div class=\"nav-item lvl-2\">\n              <a href=\"".concat(tempLang, "/taxonomy/term/").concat(multiMenu[link].id, "\"><span>").concat(multiMenu[link].name, "</span></a>");
              ...
              if (Object.keys(multiMenu[link].children).length !== 0 && multiMenu[link].children.constructor === Object) {
                ...
                for (var linkChild in multiMenu[link].children) {
                  if (multiMenu[link].children.hasOwnProperty(linkChild)) {
                    controller.menu.markup += "<div class=\"nav-item lvl-3\">\n                      ".concat(controller.menu.checkAlias(multiMenu[link].children[linkChild], controller.languageCode), "\n                      ");
                    ...
                    if (Object.keys(multiMenu[link].children[linkChild].children).length !== 0 && multiMenu[link].children[linkChild].children.constructor === Object) {
                      ...
                      for (var linkgrandChild in multiMenu[link].children[linkChild].children) {
                        if (multiMenu[link].children[linkChild].children.hasOwnProperty(linkgrandChild)) {
                          controller.menu.markup += "<div class=\"nav-item lvl-4\">\n                              <a href=\"".concat(tempLang, "/taxonomy/term/").concat(multiMenu[link].children[linkChild].children[linkgrandChild].id, "\"><span>").concat(multiMenu[link].children[linkChild].children[linkgrandChild].name, "</span></a>");
                          ...
                          if (Object.keys(multiMenu[link].children[linkChild].children[linkgrandChild].children).length !== 0 && multiMenu[link].children[linkChild].children[linkgrandChild].children.constructor === Object) {
                            ...
                            for (var linkgreatGrandChild in multiMenu[link].children[linkChild].children[linkgrandChild].children) {
                              if (multiMenu[link].children[linkChild].children[linkgrandChild].children.hasOwnProperty(linkgreatGrandChild)) {
                                controller.menu.markup += "<div class=\"nav-item lvl-5\">\n                                      <a href=\"".concat(tempLang, "/taxonomy/term/").concat(multiMenu[link].children[linkChild].children[linkgrandChild].children[linkgreatGrandChild].id, "\"><span>").concat(multiMenu[link].children[linkChild].children[linkgrandChild].children[linkgreatGrandChild].name, "</span></a>");
        ...
        controller.menu.markup += "<div class=\"nav-item lvl-1\">\n        <a href=\"".concat(protocol, "//").concat(baseURL, "/buses\"><span>").concat(transWords[4], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n         <a href=\"").concat(protocol, "//").concat(baseURL, "/jobs\"><span>").concat(transWords[5], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n        <a href=\"").concat(protocol, "//").concat(baseURL, "/pay\"><span>").concat(transWords[6], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n        <a href=\"").concat(protocol, "//").concat(baseURL, "/water\"><span>").concat(transWords[7], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n        <a href=\"").concat(protocol, "//").concat(baseURL, "/events\"><span>").concat(transWords[8], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n        <a href=\"").concat(protocol, "//").concat(baseURL, "/news\"><span>").concat(transWords[9], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n        <a href=\"").concat(protocol, "//").concat(baseURL, "/documents\"><span>").concat(transWords[10], "</span></a>\n       </div>\n       <div class=\"nav-item lvl-1\">\n         <a href=\"").concat(protocol, "//").concat(baseURL, "/forms\"><span>").concat(transWords[11], "</span></a>\n        </div>\n        <div class=\"nav-item lvl-1\">\n         <a href=\"").concat(protocol, "//").concat(baseURL, "/city-hotlines\"><span>").concat(transWords[12], "</span></a>\n        </div>\n      </article>");
      }

      var param;
      var url = 'https://apis.detroitmi.gov/data_cache/user_cache/data/'; // white listing site menu that gets cached
      // let prox;
      ...
      switch (baseURL) {
        case 'detroitmi.gov':
          ...
          param = {
            "key": "detroitmi_menu_prod_".concat(controller.languageCode),
            "data": {
        ...
        default:
          console.log('testing env'); // console.log(controller.menu.markup);
      ...
      if (param !== undefined && !error) {
        ...
        fetch(request).then(function (resp) {
          console.log(resp); // console.log(resp.status);

          if (resp.status === 201) {// console.log('item submitted');
          }
        });
    ...
    value: function navLevelChange(ev) {
      // console.log(ev);
      var pastClass = ev.target.nextElementSibling.className.split(' '); // console.log(pastClass);
    ...
    value: function searchBar(ev) {
      ...
      var str = ev.target.value.replace(/\s/g, "+"); // console.log(str);

      window.location.href = "/search?search=".concat(str);
    }
  }, {
    key: "navBackLevel",
...
},{}],"js/controller.class.js":[function(require,module,exports) {
"use strict";
...
var _menuClass = _interopRequireDefault(require("./menu.class.js"));
...
function () {
  function Controller() {
    ...
    this.menu = new _menuClass.default();
  ...
  _createClass(Controller, [{
    ...
    value: function init() {
      ...
      .then(function (data) {
        ...
        // console.log(controller.today);
        controller.cache = data.data.markup; // console.log('load cache');

        controller.menu.render(data.data.markup, controller); // console.log('time to update');
    ...
    key: "getTaxomy",
    value: function getTaxomy(baseURL, controller) {
      // console.log(baseURL);
      var departments = new Promise(function (resolve, reject) {
        var url = "https://".concat(baseURL, "/rest/menu/department-full?_format=hal_json");
        return fetch(url, {
          mode: 'cors'
        }).then(function (resp) {
          return resp.json();
      ...
      var government = new Promise(function (resolve, reject) {
        var url = "https://".concat(baseURL, "/rest/menu/government?_format=hal_json");
      ...
      var census = new Promise(function (resolve, reject) {
        var url = "https://".concat(baseURL, "/rest/menu/census?_format=hal_json");
        return fetch(url).then(function (resp) {
          return resp.json();
        }) // Transform the data into json
        .then(function (data) {
      ...
      var howDoI = new Promise(function (resolve, reject) {
        var url = "https://".concat(baseURL, "/rest/menu/interactions?_format=hal_json");
        return fetch(url, {
          mode: 'cors'
        }).then(function (resp) {
          return resp.json();
      ...
      Promise.all([departments, government, census, howDoI]).then(function (values) {
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","isomorphic-fetch":"node_modules/isomorphic-fetch/fetch-npm-browserify.js","./menu.class.js":"js/menu.class.js","moment":"node_modules/moment/moment.js"}],"index.js":[function(require,module,exports) {
'use strict';

var _controllerClass = _interopRequireDefault(require("./js/controller.class.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(function () {
  var controller = new _controllerClass.default();
  ...
  var menuToggle = function menuToggle(ev) {
    ...
    if (ev.target.checked) {
      ...
      var navContainers = Array.from(document.querySelectorAll('.active.nav-container')); // console.log(navContainers);
...
},{"./js/controller.class.js":"js/controller.class.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/decouple-drupal-menu.e31bb0bc.js.map