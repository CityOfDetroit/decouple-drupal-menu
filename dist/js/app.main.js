  ...
  _createClass(Menu, [{
    ...
    value: function buildMenuLvls(list, controller) {
      ...
      list.data.forEach(function (item) {
        var tempItem = null;
        var splitItem = item.url_alias.split('/');
        switch (true) {
          ...
          switch (lvl) {
            case 'lvl1':
              spliceMenu[lvl].forEach(function (item) {
                var tempIndex = item.data.url_alias.split('/');
